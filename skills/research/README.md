...
per-item deep research into JSON, and generate a final Markdown report. The deep-research stages
expect a Codex `web_researcher` agent to be available; install the upstream `agents-codex` files if
you want that agent-backed flow.
